...
3.  **Reverse Geo-coding**: Supply incident coordinates to [Nominatim](https://nominatim.org/release-docs/develop/api/Reverse/) API, return site type (school, hospital).
...
gaza_map <- get_googlemap(center = c(lon = 34.3900, lat = 31.4100),  #"Gaza Strip", 
                          maptype = "satellite", size = c(900, 1200), # width, height
                          zoom=12) 
...
# pagedown::chrome_print("repos/airwars_scraping_project/code/airwars_project_slides.html" )
```
:::
:::::
